              ...
              <>
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full h-12 bg-black text-white rounded-full flex items-center justify-center gap-1 hover:opacity-90 transition"
                  >
                    <svg viewBox="0 0 814 1000" className="h-[18px] w-auto fill-current" aria-hidden="true">
                  ...
                  <button
                    ...
                    className="w-full h-12 bg-white border border-[#dadce0] rounded-full flex items-center justify-center gap-1.5 hover:bg-surface transition"
                  >
