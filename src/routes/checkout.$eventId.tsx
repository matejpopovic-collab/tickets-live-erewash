          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <button
                ...
                className="h-11 px-4 bg-black text-white rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition"
              >
                <svg viewBox="0 0 814 1000" className="h-[16px] w-auto fill-current" aria-hidden="true">
